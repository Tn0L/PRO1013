<!DOCTYPE html>
<!-- saved from url=(0052)http://localhost/Project/PRO1013/mvc/admin/login.php -->
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" action="http://localhost/Project/PRO1013/mvc/admin/login.php" method="post">
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="http://localhost/Project/PRO1013/mvc/admin/forgot-password.html">Forgot Password?</a>
                  </div>
                </div>
              </div>
            </div>
