					...
					<ul class="main-categories">
						<li class="main-nav-list"><a data-toggle="collapse" href="#fruitsVegetable" aria-expanded="false" aria-controls="fruitsVegetable"><span
							...
							<?php foreach($danhmuc as $data):?>
								<li class="main-nav-list child"><a href="?act=category&id=<?=$data['ma_loai']?>"><?= $data['ten_loai']?></a></li>
							<?php endforeach; ?>
							</ul>
						</li>

						<li class="main-nav-list"><a data-toggle="collapse" href="#meatFish" aria-expanded="false" aria-controls="meatFish"><span
								 class="lnr lnr-arrow-right"></span>Nam</a>
							<ul class="collapse" id="meatFish" data-toggle="collapse" aria-expanded="false" aria-controls="meatFish">
								<?php foreach($danhmuc as $data):?>
									<li class="main-nav-list child"><a href="#"><?= $data['ten_loai']?></a></li>
								<?php endforeach; ?><li class="main-nav-list child"><a href="#">Dried Fish<span class="number">(09)</span></a></li>
							</ul>
						</li>
					</ul>
				</div>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="<?= $get_product['hinh']?>" alt="">
								<div class="product-details">
									<h6><?= $get_product['ten_san_pham']?></h6>
									<div class="price">
									...
									<div class="prd-bottom">
										...
										<a href="?act=single_product&id=<?=$get_product['ma_san_pham']?>" class="social-info">
